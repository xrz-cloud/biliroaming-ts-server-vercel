...
//用处不明
export const fs_uri: string = "https://www.xrzyun.eu.org";
//标签-副标题1
...
//立即观看按钮-主选项标题
export const fs_watch_button_title: string = "番剧删减汇总";
//立即观看按钮-主选项链接
export const fs_watch_button_link: string = "https://aniclip.xrzyun.eu.org";
//追番按钮-追番
